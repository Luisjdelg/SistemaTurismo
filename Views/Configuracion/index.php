...
<div class="app-title">
    <div>
        <h1><i class="fa fa-dashboard"></i> Datos de la Institución</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="telefono" class="form-control" type="text" name="telefono" value="<?php echo $data['telefono']; ?>" required placeholder="Teléfono" maxlength="10">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
