...
<body>
    ...
    <section class="login-content">
        ...
        <div class="logo">
            <img src="<?php echo base_url; ?>Assets/img/logoRiobamba.png" width="200">
            <img src="<?php echo base_url; ?>Assets/img/logo.png" width="100">
            <img src="<?php echo base_url; ?>Assets/img/logoturismo.png" width="300">

        </div>
        <h3 class="login-head">Sistema de Evaluación de Calidad de Servicios Turísticos Comunitarios</h3>
